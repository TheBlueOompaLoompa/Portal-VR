...
public class Portal : MonoBehaviour
{
    ...
    void UpdateCamera(Camera camera)
    {
            ...
            camera.tag != "Portal Camera")
        {
            ...
            Vector3 pcamrot = portalCamera.transform.rotation.eulerAngles;
            portalCamera.transform.rotation = Quaternion.Euler(pcamrot.x, pcamrot.y, pcamrot.z + main_cam.transform.rotation.eulerAngles.z);
        }
    }
